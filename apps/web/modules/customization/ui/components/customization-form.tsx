...
export const CustomizationForm = ({
  ...
  const form = useForm<FormSchema>({
    ...
    defaultValues: {
      ...
      vapiSettings: {
        assistantId: initialData?.vapiAssistantId || "",
        phoneNumber: initialData?.vapiPhoneNumber || "",
      },
    },
  });
        ...
        body: JSON.stringify({
          ...
          vapiAssistantId:
            values.vapiSettings.assistantId === "none"
              ? null
              : values.vapiSettings.assistantId || null,
          vapiPhoneNumber:
            values.vapiSettings.phoneNumber === "none"
              ? null
              : values.vapiSettings.phoneNumber || null,
        }),
      });
